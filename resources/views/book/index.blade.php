        ...
        @foreach ($books as $book)
            <tr>
              ...
              <td class="flex sm:flex-row flex-col pr-0 gap-2">
                ...
                <a onclick="delete_modal_{{ $loop->iteration }}.showModal()" class="btn btn-ghost text-error hover:bg-error hover:text-base-100 w-16 inline-flex items-center cursor-pointer p-2">
                  Delete
                </a>
              </td>
            </tr>
